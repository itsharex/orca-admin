...
import { getInfoList } from "@/api/modules/info";
...
const login = (formEl: FormInstance | undefined) => {
  ...
  formEl.validate(async valid => {
    ...
    try {
      ...
      if (res.token) {
        const InfoData = await getInfoList();
        let ogrId = +InfoData?.data?.id;
        console.log(ogrId, "InfoData");
        userStore.setOrgId(ogrId);
        userStore.setUserInfo({ name: loginForm.account });
      }
