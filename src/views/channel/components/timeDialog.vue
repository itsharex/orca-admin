...
const columns = reactive([
  { prop: "roomName", label: "直播", minWidth: 220 },
  { prop: "beginTime", label: "开始时间", minWidth: 180 },
  { prop: "endTime", label: "结束时间", minWidth: 180 },
  { prop: "flowPeople", label: "引流人数", minWidth: 120 },
  { prop: "transactionAmount", label: "成交金额", minWidth: 120 },
  { prop: "commissionRatio", label: "分佣比例", minWidth: 120 },
  { prop: "subCommission", label: "分佣金额", minWidth: 120 }
]);
...
const getTableList = (params: any) => {
  return getTimeDimensionDetail({ ...params, channelId: props.channelId, date: props.date });
};
</script>
