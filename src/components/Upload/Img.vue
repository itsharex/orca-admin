    ...
    >
      <template v-if="imageUrl">
        ...
        <div class="upload-handle" @click.stop>
          ...
          <div v-if="self_disabled" class="handle-icon" @click="imgViewVisible = true">
      ...
      <template v-else>
        <div class="upload-empty">
          <slot name="empty">
            ...
            <img src="@/assets/images/upload-empty.png" class="empty-img" alt="" />
            <!-- <span>请上传图片</span> -->
          </slot>
        </div>
      </template>
...
const handleHttpUpload = async (options: UploadRequestOptions) => {
  ...
  try {
    ...
    emit("update:imageUrl", imgData.fileUrl);
    setTimeout(() => {
