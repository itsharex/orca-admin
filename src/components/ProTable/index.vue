<template>
  ...
  <!-- 表格主体 -->
  <div class="card table-main mt10">
    <!-- 表格头部 操作按钮 -->
...
const copyText = (row, column, cell, event) => {
  console.log(row, column, cell, event);
  console.log("has copy", column.className == "copy");
  if (column.className == "copy") {
